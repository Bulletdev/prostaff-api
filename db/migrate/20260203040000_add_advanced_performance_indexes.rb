class AddAdvancedPerformanceIndexes < ActiveRecord::Migration[7.2]
  def change
    ...
    add_index :matches, [:organization_id, :game_start, :victory],
    ...
    add_index :team_goals, [:organization_id, :status],
    ...
    add_index :schedules, [:organization_id, :start_time, :event_type],
    ...
    add_index :player_match_stats, [:match_id, :player_id],
